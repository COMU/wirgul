...
urlpatterns = patterns('',
    ...
    url(r'^already_exist/$', 'web.views.new_user', name='new_user_already_exist_view'),
    ...
    url(r'^get_times/$', 'web.views.get_times', name='get_times'),
    ...
    url(r'^guest_user/$', 'web.views.guest_user', name='guest_user_view'),
    url(r'^guest_user/(?P<url_id>\w+)/$', 'web.views.guest_user_registration', name='guest_user_registration_view'),
