...
urlpatterns = patterns('',
    ...
    url(r'^passwordchange/invalid_mail/$', 'web.views.passwordchange', name='invalid_mail_views'),
    ...
    url(r'^passwordchange/(?P<url_id>\w+)/$', 'web.views.password_change_registration', name='password_change_registration'),
