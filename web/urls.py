...
urlpatterns = patterns('',
    ...
    url(r'^password_change/$', view=password_change, name='password_change_view'),
    ...
    url(r'^password_change/(?P<url_id>\w+)/$', view=password_change_registration, name='password_change_registration'),
    url(r'^guest_user/$', view=guest_user, name='guest_user_view'),
